...
Throughout my time here, I’ve mainly used Google Apps Script and Python to build efficient solutions, Google Sheets Query functions for dynamic data manipulation, making it easier to generate real-time reports and R for data analysis. For visualizing insights, I’ve worked with ggplot2, Tableau, Genially, Figma, and Lucidchart ensuring complex data is presented in a clear, engaging, and accessible way for stakeholders. Additionally, I built a landing page and an analysis dashboard using Google Sites, keeping the design simple and user-friendly. I wanted to make sure it was easy to navigate and that people could quickly find the information they needed.
